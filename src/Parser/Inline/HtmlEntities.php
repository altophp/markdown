...
/**
 * Generated HTML5 named entity table from the WHATWG entities.json, keeping
 * only names with a trailing semicolon (CommonMark 0.31.2). Do not edit by
 * hand; regenerate with `php bin/generate-entities.php`. Keys are the bare
 * entity name (no "&", no ";"); values are the replacement as UTF-8.
 *
 * @internal
 *
...
final class HtmlEntities
{
    ...
    /**
     * The UTF-8 replacement for a named entity, or null when the name is not
     * a valid HTML5 entity reference.
     */
