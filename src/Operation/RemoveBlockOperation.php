 ...
 */
final readonly class RemoveBlockOperation implements Operation
{
    ...
    {
        $this->parsed($model)->removeBlock($this->target);
    }

    public function toPatch(DocumentModel $model): SourcePatch
    {
        return new SourcePatch($this->range, '', $this->range, $this->describe());
    }
